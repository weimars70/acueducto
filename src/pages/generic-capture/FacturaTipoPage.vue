...
onMounted(() => {
  console.log('FacturaTipoPage montado - Iniciando carga de registros');
  ...
  <q-page padding>
    <div class="q-pa-md">
      ...
      <q-card class="q-mb-md">
        <q-card-section>
          <div class="text-h6">{{ editMode ? 'Editar Factura Tipo' : 'Nueva Factura Tipo' }}</div>
        </q-card-section>
